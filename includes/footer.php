		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--account">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<span class="footer-nav__link"> cart</span>
					</li>
					<li class="footer-nav__item">
						<span class="footer-nav__link"> lookbook</span>
					</li>
					<li class="footer-nav__item">
						<span class="footer-nav__link"> order</span>
					</li>
					<li class="footer-nav__item">
						<span class="footer-nav__link">Update information</span>
					</li>
				</ul>
			</div>
